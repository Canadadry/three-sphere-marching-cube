function extractMarchingIdFromFieldAt(field,x,y,z)
{
	let data = [
	];
	...
	for(let i=0;i<8;i++)
	{
		...
		data.push(
			field[x+offset.x][y+offset.y][z+offset.z]
		);
	}
	return dataToMarchingCubeIndex(data);
}


function dataToMarchingCubeIndex(d)
{
